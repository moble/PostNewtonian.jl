...
"""
@compute_pn_variables function 𝓕(pnstate)
    32ν^2/5 * v^10 * (
        ...
        + v^12 * (
            ...
            - 54784π^2*log2/315 - 246137536815857γₑ/157329572400 - 437114506833log3/789268480
            - 256π^4/45 - 27392γₑ*π^2/315 - 27392ζ3/105 - 37744140625log5/260941824
            + 1465472γₑ^2/11025 + 5861888γₑ*log2/11025 + 5861888log2^2/11025
...
"""
@compute_pn_variables function 𝓕NS(pnstate, λ₁, λ₂)
    32ν^2/5 * v^10 * (
