    ...
    return 32c^5 / 5G *
           ...
           @pn_expansion(
               ...
               1 +
                   ...
                   (v / c)^5 * ((-8191//672 - 583ν / 24)π) +
                   (v / c)^6 * (
                       6643739519//69854400 + 16π^2 / 3 -
                       1712 * (γₑ + 2ln(2) + ln(v)) / 105 + (-134543//7776 + 41π^2 / 48)ν -
                       94403ν^2 / 3024 - 775ν^3 / 324
                   ) +
                   (v / c)^7 * ((-16285//504 + 214745ν / 1728 + 193385ν^2 / 3024)π) +
                   (v / c)^8 * (
                       -323105549467//3178375200 + 232597γₑ / 4410 - 1369π^2 / 126 +
                       39931ln(2) / 294 - 47385ln(3) / 1568 +
                       232597ln(v) / 4410 +
                       (
                   ...
                   (v / c)^9 * (
                       (
                           265978667519//745113600 - 6848 * (γₑ + 2ln(2) + ln(v)) / 105 +
                   ...
                   (v / c)^12 * (
                       -271272899815409ln(2) / 157329572400 - 54784π^2 * ln(2) / 315 -
                       246137536815857γₑ / 157329572400 - 437114506833ln(3) / 789268480 -
                       256π^4 / 45 - 27392γₑ * π^2 / 315 - 27392ζ3 / 105 -
                       37744140625ln(5) / 260941824 +
                       1465472γₑ^2 / 11025 +
                       5861888γₑ * ln(2) / 11025 +
                       5861888ln(2)^2 / 11025 +
