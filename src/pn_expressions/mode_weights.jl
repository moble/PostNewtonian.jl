...
@pn_expression 2 function h!(h, pnsystem; ℓₘᵢₙ=0, ℓₘₐₓ=typemax(Int))
    ...
    if ℓₘₐₓ ≥ 2
        ...
        h[Yindex(2,1,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            (v/c)^1 * (𝒾 * δ / 3)
            + (v/c)^3 * (𝒾 * δ * (-17 + 20ν) / 84)
            + (v/c)^4 * ((δ * (1 + 2𝒾*π + 4ln(2))) / 6)
            + (v/c)^5 * (𝒾 * δ * (-172 + ν * (-2036 + 237ν)) / 1512)
            + (v/c)^6 * (δ*(-34𝒾*π - 17*(1 + 4ln(2)) + 2ν * (353 + 6𝒾*π + 12ln(2))) / 168)
        )
        h[Yindex(2,2,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^6 * (
                ...
                + 41ν * π^2 / 96 + (2π*(214𝒾 + 35π))/105 - 1712ln(2)/105
                - (856//105)*ln(v)
            )
            + (v/c)^7 * ((-2𝒾 * ν * (-501655 + 24396ν) + 15*(-2173 + 2ν*(-2459 + 560ν))π) / 11340)
            # Eq. (6.17) of Blanchet et al. (2023)
            + (v/c)^8 * (
                - 846557506853//12713500800 + 45796γₑ/2205 - 22898𝒾*π/2205 - 107π^2/63 + 45796(2ln(2)+ln(v))/2205
                + (-336005827477//4237833600 + 15284γₑ/441 - 219314𝒾*π/2205 - 9755*π^2/32256 + 15284(2ln(2)+ln(v))/441)ν
    ...
    if ℓₘₐₓ ≥ 3
        ...
        h[Yindex(3,1,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            (v/c)^1 * (𝒾 * δ / 12√14)
            + (v/c)^3 * (-𝒾 * δ * (4 + ν) / 18√14)
            + (v/c)^4 * (δ * (7 + 5𝒾*π + 10ln(2)) / 60√14)
            + (v/c)^5 * (-𝒾 * δ * (-607 + ν*(272 + 247ν)) / 2376√14)
            + (v/c)^6 * (
                δ * (-5𝒾 * (16 + 7ν)π + 2*(-56 + ν - 5*(16 + 7ν)*ln(2))) / 360√14
            )
            + (v/c)^7 * (
                𝒾 * δ / 12√14 * (
                    (10753397//1513512) - 2ln(2)*((212//105) + ln(2)) - (26//21)*γₑ + (π^2/6)
                    - 2𝒾*π*((41//105) + ln(2)) + (ν/8)*(-(1738843//19305) + (41//8)*π^2)
        ...
        h[Yindex(3,3,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^4 * (√(243//70) * δ * (-7 - 5𝒾*π + 10ln(3/2)) / 4)
            + (v/c)^5 * (-𝒾 * √(3//542080) * δ * (369 + (-3676 + 887ν)ν))
            + (v/c)^6 * (δ * (-3645𝒾 * (-8 + 3ν)π + (40824 - 96206ν + 7290*(-8 + 3ν)ln(3/2))) / 216√210)
            + (v/c)^7 * (
                ((-3𝒾)/4) * √(15//14) * δ * (
                    (19388147//280280) + (492//35)ln(3/2) - 18*ln(3/2)^2 - (78//7)γₑ + (3//2)π^2
                    + 6𝒾 * π * (-41//35 + 3ln(3/2))
    ...
    if ℓₘₐₓ ≥ 4
        ...
        h[Yindex(4,1,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^6 * (δ * (64 - 1661ν - 30𝒾*(-1 + 2ν)π + 60*(1 - 2ν)ln(2)) / 2520√10)
        )
        ...
        h[Yindex(4,3,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^6 * (δ * (-5184 + 16301ν + 2430𝒾*(-1 + 2ν)π + 4860*(1 - 2ν)ln(3/2)) / 360√70)
        )
        h[Yindex(4,4,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            (v/c)^2 * (8 * √(5//7) * (-1 + 3ν) / 9)
            + (v/c)^4 * (4 * (1779 + 5ν*(-1273 + 525ν)) / 297√35)
            + (v/c)^5 * ((160*(-1 + 3ν)π + 𝒾*(336 - 1193ν + 320*(-1 + 3ν)ln(2))) / 9√35)
    ...
    if ℓₘₐₓ ≥ 5
        h[Yindex(5,1,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^6 * (δ * (181 - 70𝒾*(-1 + 2ν)π + 140ln(2) - 28ν*(313 + 10ln(2))) / 20160√385)
        )
        ...
        h[Yindex(5,3,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^6 * (δ * (-395847 + 1171828ν + 153090𝒾*(-1 + 2ν)π - 306180*(-1 + 2ν)*ln(3/2)) / 60480√330)
        )
        ...
        h[Yindex(5,5,ℓₘᵢₙ)] = h₀ * @pn_expansion(
            ...
            + (v/c)^6 * (δ * (565625 - 1481676ν - 218750𝒾*(-1 + 2ν)π + 437500*(-1 + 2ν)ln(5/2)) / 6720√66)
        )
    end
