...
"""
@public rₕ₁(s::PNSystem) = M₁(s) * (1 + √(1 - min(χ₁²(s), 1)))
...
on ["Horizons"](@ref Horizons) for more details.
"""
@public Ωₕ₁(s::PNSystem) = χ₁(s) / 2rₕ₁(s)
...
"""
@public function sin²θ₁(s::PNSystem)
    let χ₁² = χ₁²(s)
...
See the documentation section on ["Horizons"](@ref Horizons) for more details.
"""
@public function ϕ̇̂₁(s::PNSystem)
